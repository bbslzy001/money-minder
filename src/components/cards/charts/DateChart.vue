...
const drawChart = () => {
  let myChart = echarts.getInstanceByDom(document.getElementById('date-chart') as HTMLElement);
  if (myChart === undefined) {
    myChart = echarts.init(document.getElementById('date-chart') as HTMLElement);
  }
  let option;
