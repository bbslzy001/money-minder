  ...
  <el-container direction="vertical">
    <el-row :gutter="24" style="margin-bottom: 24px;">
      ...
      <el-col :span="6" style="height: 160px;">
        <DateSettingCard :date="dateRange.currentDate[1]" :date-extra="dateRange.currentDate[2]" :date-value="dateRange.currentDate[0]" date-type="month" @handle-date-change="updateDate"/>
      </el-col>
    </el-row>
    <el-row :gutter="24">
      <el-col :span="14">
      ...
      <el-col :span="10">
        <el-row :gutter="24" style="margin-bottom: 24px;">
          <el-col :span="24" style="height: 400px;">
            <MonthCalendarChart :start-date="dateRange.startDate[1]" :end-date="dateRange.endDate[1]"/>
          </el-col>
        </el-row>
        <el-row :gutter="24">
...
import MonthCalendarChart from "@/components/cards/charts/MonthCalendarChart.vue";
